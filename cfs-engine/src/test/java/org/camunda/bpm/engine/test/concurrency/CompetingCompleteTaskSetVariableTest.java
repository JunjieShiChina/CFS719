...
public class CompetingCompleteTaskSetVariableTest extends ConcurrencyTestCase {
  ...
  protected static class ControllableCompleteTaskCommand extends ControllableCommand<Void> {
  ...
  public class ControllableSetTaskVariablesCommand extends ControllableCommand<Void> {
  ...
  public void testCompleteTaskSetLocalVariable() {
    ...
    ThreadControl thread1 = executeControllableCommand(new ControllableSetTaskVariablesCommand(taskId, Variables.createVariables().putValue("var", "value")));
    thread1.reportInterrupts();
    thread1.waitForSync();

    ThreadControl thread2 = executeControllableCommand(new ControllableCompleteTaskCommand(taskId));
