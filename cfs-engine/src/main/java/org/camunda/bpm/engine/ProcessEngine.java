 ...
 * <ul>
 * <li>
 * <b>{@link RuntimeService}: </b> Allows the creation of
 ...
 * <li>
 * <b>{@link TaskService}: </b> Exposes operations to manage human
 * (standalone) {@link org.camunda.bpm.engine.task.Task}s, such as claiming, completing and
 * assigning tasks</li>
 * <li>
 * <b>{@link IdentityService}: </b> Used for managing
 ...
 * <li>
 * <b>{@link ManagementService}: </b> Exposes engine admin and
 * maintenance operations</li>
 *  <li>
 * <b>{@link HistoryService}: </b> Service exposing information about
 * ongoing and past process instances.</li>
 *
 * <li><b>{@link AuthorizationService}:</b> Service allowing
