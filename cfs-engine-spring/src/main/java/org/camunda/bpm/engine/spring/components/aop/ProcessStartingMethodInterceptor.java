...
/**
 * {@link MethodInterceptor} that starts a business process
...
public class ProcessStartingMethodInterceptor implements MethodInterceptor {
	...
	/**
	 * @param processEngine takes a reference to a {@link ProcessEngine}
	 */
	 ...
	 *
	 * @param invocation the invocation of the method as passed to the {@link MethodInterceptor#invoke(MethodInvocation)} method
